...
$templatefile= 'C:\Users\ritik.d\Desktop\web-app\db-template.json'                               #path to template file
$parameterfile= 'C:\Users\ritik.d\Desktop\web-app\db-parameters.json'                             # path to parameter file
$rg= 'sam'                                              #resource group name
