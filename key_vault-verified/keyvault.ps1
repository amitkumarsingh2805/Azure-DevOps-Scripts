...
$templatefile= 'C:\Users\roopsa.d\Desktop\DONE\keyvault\template.json'    #path to template file
$parameterfile= 'C:\Users\roopsa.d\Desktop\DONE\keyvault\parameters.json' #path to parameter file
$rg= 'testabc123'                                                    #resource group name
$loc= 'northcentralus'                                               #location
$name= 'testroopsa1'                                                 #name of key vault
